...
public class Sudokufile extends javax.swing.JFrame {
     ...
     */
    private String turn = "1"; //stores the value of selection button 
    ...
    private void initComponents() {
        ...
        solutnbtn.setBackground(new java.awt.Color(102, 255, 51));
        solutnbtn.setText("SOLUTION");
        ...
        checkbtn.setBackground(new java.awt.Color(255, 51, 153));
